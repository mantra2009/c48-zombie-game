...
function preload(){
  ...
  shooterImg = loadImage("assets/player1.png")
  shooter_shooting = loadImage("assets/player2.png")

  zombieImg = loadImage("assets/zombiee.png")
...
player = createSprite(displayWidth-1150, displayHeight-300, 50, 50);
 player.addImage(shooterImg)
  ...
  // player.debug = true
   ...
   heart1 = createSprite(displayWidth-200,100,20,20)
   heart1.visible = false
    heart1.addImage("heart1",heart1Img)
    heart1.scale = 0.4

    heart2 = createSprite(displayWidth-125,100,20,20)
    heart2.visible = false
    heart2.addImage("heart2",heart2Img)
    heart2.scale = 0.4

    heart3 = createSprite(displayWidth-200,100,20,20)
...
textSize(22)
  fill("white")
text("Bullets = " + bullets,displayWidth-230,displayHeight/2-220)
text("Score = " + score,displayWidth-220,displayHeight/2-200)
text("Lives = " + life,displayWidth-220,displayHeight/2-240)
